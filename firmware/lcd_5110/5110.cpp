...
// embedblog.eu/dmm
// some code of this LCD driver comes from Adafruit Industries, I've only rewriten it for STM32F1
// ===================================================
...
void LCD_5110::begin(uint8_t contrast, uint8_t bias) 
{
  //========================
	...
	//PB3 and PB5 as high speed alternate push-pull outputs
	GPIOB->CRL |= GPIO_CRL_MODE3_0 | GPIO_CRL_MODE3_1 | GPIO_CRL_MODE5_0 | GPIO_CRL_MODE5_1;
	GPIOB->CRL &=~(GPIO_CRL_CNF3_0 | GPIO_CRL_CNF5_0);
	GPIOB->CRL |= GPIO_CRL_CNF3_1 | GPIO_CRL_CNF5_1;
	
	//remap SPI1
	AFIO->MAPR |= AFIO_MAPR_SPI1_REMAP;
	
	//SCK frequency 4 MHz (div / 16), master, software slave control
...
void LCD_5110::spiWrite(uint8_t d) 
{
	...
	_delay_us(0);	//this is, for some reason, needed TODO: research
}
