...
//PIN DEFINITIONS
#define RST_HIGH		GPIOB->BSRR = GPIO_BSRR_BS9
#define RST_LOW			GPIOB->BSRR = GPIO_BSRR_BR9
#define CE_HIGH			
#define CE_LOW			
#define DC_HIGH			GPIOB->BSRR = GPIO_BSRR_BS8
#define DC_LOW			GPIOB->BSRR = GPIO_BSRR_BR8
#define DIN_HIGH		GPIOB->BSRR = GPIO_BSRR_BS5
#define DIN_LOW			GPIOB->BSRR = GPIO_BSRR_BR5
#define CLK_HIGH		GPIOB->BSRR = GPIO_BSRR_BS3
#define CLK_LOW			GPIOB->BSRR = GPIO_BSRR_BR3
