...
#line 89 "RTE\\Device\\STM32F373CC\\system_stm32f3xx.c"
...
#line 278 "RTE\\Device\\STM32F373CC\\system_stm32f3xx.c"
      if (pllsource == ((uint32_t)0x00000000))
      {
      ...
      {
        predivfactor = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR2 & ((uint32_t)0x0000000F)) + 1;
