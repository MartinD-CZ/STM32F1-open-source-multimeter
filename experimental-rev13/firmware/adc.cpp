...
void adc1_init(void)
{
	...
	//convert CH1, CH2 and CH8
	ADC1->SQR1 = (11 << 20);
	ADC1->SQR3 = (2 << 0) | (1 << 5) | (8 << 10) | (2 << 15) | (1 << 20) | (8 << 25);
	ADC1->SQR2 = (2 << 0) | (1 << 5) | (8 << 10) | (2 << 15) | (1 << 20) | (8 << 25);
